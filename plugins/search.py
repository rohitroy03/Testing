...
async def recheck(bot, update):
    ...
    try:
       ...
       if bool(results)==False:          
          return await update.message.edit("Still no results found! Please Request To Group Admin", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('Click To Check Spelling ✅', callback_data=f"request_{id}")]]))], [InlineKeyboardButton('Click To Check Spelling ✅', url=f'http://www.google.com/search?q={message.text.replace(" ", "%20")}%20Movie')]
